...
// import { LiveAssistanceStatus } from "@/features/user/pages/liveAssistance/bookingDetails";
...
//         // liveAssistServiceHistory: builder.query<ServiceHistoryResponse, { page: number }>({
//         //     query: ({ page }) => ({
