...
//                   <Button
//                     variant="outline"
//                     className="w-full sm:w-auto border-slate-300 hover:bg-slate-50 bg-transparent text-sm"
//                   >
//                     <Settings className="w-3 h-3 mr-1" />
//                     Manage Features
//                   </Button>
//                 </DialogTrigger>
//                 <DialogContent className="w-[95vw] max-w-2xl h-[80vh] flex flex-col bg-white rounded-lg shadow-lg border-0 p-0">
...
//                           className="flex-1 border-slate-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm"
//                         />
//                         <Button
//                           onClick={addNewFeature}
//                           disabled={!newFeatureName.trim()}
//                           className="bg-blue-600 hover:bg-blue-700 text-white px-4 w-full sm:w-auto text-sm"
//                         >
...
//                 <DialogTrigger asChild>
//                   <Button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold shadow-lg w-full sm:w-auto text-sm">
//                     <Plus className="w-3 h-3 mr-1" />
//                     Create Plan
//                   </Button>
//                 </DialogTrigger>
//                 <DialogContent className="w-[95vw] max-w-3xl h-[85vh] flex flex-col bg-white rounded-lg shadow-lg border-0 p-0">
//                   <DialogHeader className="border-b border-slate-200 p-4">
//                     <DialogTitle className="text-lg font-bold text-slate-900 flex items-center gap-2">
...
//                     variant="outline"
//                     size="sm"
//                     className="flex-1 border-slate-200 hover:border-blue-300 hover:bg-blue-50 hover:text-blue-600 text-sm bg-transparent"
...
//                     variant="outline"
//                     size="sm"
//                     className="flex-1 border-red-200 text-red-600 hover:border-red-300 hover:bg-red-50 text-sm bg-transparent"
...
//         </div>
//         {plans.length === 0 && (
//           <Card className="text-center py-8 bg-white rounded-lg shadow-lg border-0">
...
//             <DialogContent className="w-[95vw] max-w-sm bg-white rounded-lg shadow-lg border-0">
...
//                     placeholder="Enter feature name"
//                     className="border-slate-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm"
//                   />
//                 </div>
//                 <div className="flex flex-col sm:flex-row gap-2">
//                   <Button
...
//           <AlertDialogContent className="w-[95vw] max-w-sm bg-white rounded-lg shadow-lg border-0">
//             <AlertDialogHeader>
...
//               <AlertDialogCancel className="border-slate-200 w-full sm:w-auto text-sm">Cancel</AlertDialogCancel>
//               <AlertDialogAction
...
//                 <SelectTrigger className="border-slate-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 bg-white flex-1 text-sm">
...
//                   className="border-slate-200 hover:bg-slate-50 w-full sm:w-auto text-sm"
//                 >
//                   Clear Inheritance
//                 </Button>
//               )}
...
//               💡 <strong>Tip:</strong> Select a plan to copy its features. You can add or remove features below.
//             </p>
//           </div>
//         </div>
//       </div>
...
//             onClick={onSubmit}
//             disabled={submitting}
//             className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-2 text-sm font-semibold"
//           >
...
//             onClick={onCancel}
//             disabled={submitting}
//             className="flex-1 border-slate-200 py-2 text-sm font-semibold bg-transparent"
//           >
//             Cancel
//           </Button>
//         </div>
