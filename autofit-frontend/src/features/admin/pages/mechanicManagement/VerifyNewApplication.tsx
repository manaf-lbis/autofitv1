...
//     if (!data?.data.mechanicProfile) return;
//     try {
//       await updateApplicationStatus({ id: data.data.mechanicProfile._id, status: "rejected" }).unwrap();
...
//                         <img
//                           src={mechanicProfile.photo || "/placeholder.svg"}
//                           alt="Profile Photo"
...
//                           variant="outline"
//                           size="sm"
//                           onClick={() => openDocument(mechanicProfile.photo)}
...
//                       <div className="w-full rounded-lg overflow-hidden border border-gray-200 bg-white">
//                         <img
//                           src={mechanicProfile.shopImage || "/placeholder.svg"}
//                           alt="Shop Image"
//                           className="w-full h-auto max-h-96 object-contain"
//                           loading="lazy"
//                         />
...
//                           variant="outline"
//                           size="sm"
//                           onClick={() => openDocument(mechanicProfile.shopImage)}
...
//                           variant="outline"
//                           size="sm"
//                           onClick={() => openDocument(mechanicProfile.qualification)}
...
//                     Are you sure you want to block this mechanic? This will prevent them from accessing the platform and accepting new jobs.
//                   </p>
...
//                 <div className="py-4">
//                   <p className="text-sm text-gray-600">
//                     Are you sure you want to unblock this mechanic? This will restore their access to the platform.
//                   </p>
//                   <div className="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-100">
//                     <p className="font-medium text-sm">{mechanic.name}</p>
//                     <p className="text-sm text-gray-500">{mechanic.email}</p>
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <Card
          className={cn(
            "border-0 shadow-sm",
            mechanic.status === "active" && "bg-green-50 border-green-200",
            mechanic.status === "blocked" && "bg-red-50 border-red-200",
            mechanic.status === "inactive" && "bg-yellow-50 border-yellow-200"
          )}
        >
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p
                    className={cn(
                      "font-medium",
                      mechanic.status === "active" && "text-green-800",
                      mechanic.status === "blocked" && "text-red-800",
                      mechanic.status === "inactive" && "text-yellow-800"
                    )}
                  >
                    {mechanic.status === "active"
                      ? "Active Account"
                  ...
                  {mechanicProfile && (
                    <p
                      className={cn(
                        "text-sm",
                        mechanic.status === "active" && "text-green-600",
                        mechanic.status === "blocked" && "text-red-600",
                        mechanic.status === "inactive" && "text-yellow-600"
                      )}
                    >
                      Registered: {formatDateTime(mechanicProfile.createdAt)}
                    </p>
              ...
              <Badge
                variant="outline"
                className={cn(
                  mechanic.status === "active" && "bg-green-100 text-green-800 border-green-300",
                  mechanic.status === "blocked" && "bg-red-100 text-red-800 border-red-300",
                  mechanic.status === "inactive" && "bg-yellow-100 text-yellow-800 border-yellow-300"
                )}
              >
                {mechanic.status.charAt(0).toUpperCase() + mechanic.status.slice(1)}
              </Badge>
                      ...
                      <div>
                        ...
                        <Badge
                          ...
                          className={cn(
                            ...
                            mechanicProfile.registration.status === "approved" &&
                              "bg-green-100 text-green-800 border-green-200",
                            mechanicProfile.registration.status === "rejected" &&
                              "bg-red-100 text-red-800 border-red-200"
                          )}
                        >
                          {mechanicProfile.registration.status.charAt(0).toUpperCase() +
