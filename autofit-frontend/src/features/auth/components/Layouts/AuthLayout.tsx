...
// import adminImg from '@/assets/adminSide/adminLoginImg.png';
// import AdminLoginAnimation from '@/components/Animations/admin/LoginPage'
...
//   // admin: { bg: 'bg-adminBlue', image: adminImg },
//   admin: { bg: 'bg-adminBlue', image:  AdminLoginAnimation},
// };
...
// ✅ Updated config to use correct variable name for the component
const config: Record<Role, { bg: string; image: string | React.FC }> = {
  user: { bg: 'bg-af_darkBlue', image: userImg },
  mechanic: { bg: 'bg-af_darkBlue', image: mechImg },
