          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={service.id}
                  className={`relative ${service.cardBg} ${service.borderColor} border-2 rounded-3xl p-1 shadow-lg  hover:shadow-blue-500/20 transition-all duration-700 hover:-translate-y-1 hover:scale-[1.02] group hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] hover:border-blue-300/70`}
                  style={{
                    animationDelay: `${index * 150}ms`,
                  }}
                >
                  <Card
                    className="bg-white border-0 rounded-[20px] overflow-hidden cursor-pointer group-hover:bg-gradient-to-br group-hover:from-white group-hover:to-gray-50/50 transition-all duration-700 h-full"
                  ...
                  >
                    <CardContent className="p-6 sm:p-8 h-full flex flex-col">
                      ...
                      <div className="mb-6 sm:mb-8">
                        <div
                          className={`inline-flex p-3 sm:p-4 rounded-2xl ${service.iconBg} shadow-md group-hover:scale-105 group-hover:shadow-lg transition-all duration-700`}
                        >
                      ...
                      <div className="flex-grow mb-6 sm:mb-8">
                        <p className="text-sm sm:text-base font-medium text-gray-500 mb-2 sm:mb-3">
                          {service.subtitle}
                        </p>
                      ...
                      {/* Button */}
                      <Button
                        className={`w-full ${service.buttonColor} text-white font-semibold py-3 sm:py-4 px-6 rounded-xl text-sm sm:text-base transition-all duration-500 relative overflow-hidden before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full before:bg-gradient-to-r before:from-transparent before:via-white/30 before:to-transparent before:transition-all before:duration-1000 hover:before:left-[100%] group-hover:before:left-[100%] hover:shadow-[0_0_25px_rgba(59,130,246,0.6)] group-hover:shadow-[0_0_25px_rgba(59,130,246,0.6)]`}
                      >
                        Book This Service
                      </Button>
                    </CardContent>
