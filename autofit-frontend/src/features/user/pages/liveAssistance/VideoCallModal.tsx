...
export function VideoCallModal({ isOpen, onClose, mechanicName, bookingTime ,sessionId ,mechanicId}: VideoCallModalProps) {
  ...
  useEffect(()=>{
    socket.emit('liveAssistance',{sessionId, mechanicId})
  },[])
