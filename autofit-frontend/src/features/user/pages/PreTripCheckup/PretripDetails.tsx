...
//               </div>
//               <h2 className="text-sm font-semibold text-gray-900">Mechanic Details</h2>
//             </div>
//             <div className="space-y-2">
//               <div className="flex justify-between items-center py-2 border-b border-gray-100">
//                 <span className="text-sm text-gray-600">Assigned Mechanic</span>
//                 <span className="font-medium text-gray-900 text-sm">{data?.mechanicId?.name}</span>
//               </div>
//               <div className="flex justify-between items-center py-2 border-b border-gray-100">
//                 <span className="text-sm text-gray-600">Email</span>
//                 <span className="font-medium text-gray-900 text-sm">{data?.mechanicId?.email}</span>
//               </div>
//               <div className="flex justify-between items-center py-2">
//                 <span className="text-sm text-gray-600">Mobile</span>
//                 <span className="font-medium text-gray-900 text-sm">{data?.mechanicId?.mobile}</span>
//               </div>
//             </div>
//           </div>
...
//                 <div className="flex justify-between py-2.5 border-b border-gray-100">
//                   <span className="text-sm text-gray-600">Assigned Mechanic</span>
//                   <span className="font-medium text-gray-900">{data?.mechanicId?.name}</span>
//                 </div>
//                 <div className="flex justify-between py-2.5 border-b border-gray-100">
//                   <span className="text-sm text-gray-600">Email</span>
//                   <span className="font-medium text-gray-900">{data?.mechanicId?.email}</span>
//                 </div>
//                 <div className="flex justify-between py-2.5">
//                   <span className="text-sm text-gray-600">Mobile</span>
//                   <span className="font-medium text-gray-900">{data?.mechanicId?.mobile}</span>
//                 </div>
//               </div>
//             </CardContent>
//           </Card>
