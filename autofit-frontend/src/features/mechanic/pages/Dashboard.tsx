...
//   // Set initial emergency request from API (only once)
//   useEffect(() => {
...
//     socket.on("emergency", (data: EmergencyRequest) => {
...
//                   {activeTab === "emergency" && ( <EmergencyTab emergencyRequest={emergencyRequest ?? null} /> )}
