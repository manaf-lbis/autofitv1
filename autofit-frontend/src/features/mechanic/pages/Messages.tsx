...
import { Send, Check, CheckCheck, X, Clock, MessageSquare, Circle, ArrowLeft } from "lucide-react";
...
export default function MessagesPage() {
  ...
  return (
    <div className="h-[calc(100vh-120px)] bg-gray-50 flex">
      ...
      <div
        className={`fixed lg:relative inset-y-0 left-0 z-50 w-80 bg-white border-r border-gray-200 flex flex-col transform transition-transform duration-200 ease-out ${isMobileSidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"
          }`}
      >
        {/* Header */}
